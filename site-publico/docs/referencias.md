...
ZirconTrace no inventa etapas nuevas: ancla cada una en un estándar de la industria ya reconocido. Estas son las referencias que usamos.

| Framework | Dónde lo usamos | Fuente |
|---|---|---|
| **AWS Well-Architected Framework** | Read (revisión del estado actual) y Architect (checklist de diseño), sobre los 6 pilares: Operational Excellence, Security, Reliability, Performance Efficiency, Cost Optimization, Sustainability. | [aws.amazon.com/architecture/well-architected](https://aws.amazon.com/architecture/well-architected/) |
